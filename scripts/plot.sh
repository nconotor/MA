...
#
# This script is slightly modified from https://www.osadl.org/Create-a-latency-plot-from-cyclictest-hi.bash-script-for-latency-plot.0.html
#

# 2. Get maximum, average and minimum (max for each) latency
...
set terminal png\n\
set xlabel \"Latency (us), max $max us, avg $avg, min $min\"\n\
set logscale y\n\
set xrange [0:200]\n\
set yrange [0.8:*]\n\
